...
public class infoOwnerD extends JFrame {
	...
	private Font f;
	private JLabel dt, last, discount;
	private JLabel user;
	...
	private ImageIcon Save, Clean, Back, Next;
	...
	public void initComponent() {
		...
		userf.setBounds(400, 70, 150, 45);
		userf.setFont(f);
		c.add(userf);
		lastf = new JTextField();
		lastf.setBounds(690, 70, 150, 45);
		lastf.setFont(f);
		c.add(lastf);

		phnumbef = new JTextField();
		phnumbef.setBounds(400, 135, 440, 45);
		phnumbef.setFont(f);
		c.add(phnumbef);
		...
		save.setBounds(690, 670, 70, 70);
		c.add(save);

		clear = new JButton(Clean);
		clear.setBounds(380, 670, 70, 70);

		c.add(clear);

		back = new JButton(Back);
		back.setBounds(140, 680, 70, 70);

		back.setBackground(Color.getHSBColor(205, 255, 105));
		c.add(back);

		next = new JButton(Next);
		next.setBounds(970, 680, 70, 70);
